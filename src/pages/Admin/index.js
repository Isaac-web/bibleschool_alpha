        ...
        <Container maxWidth="xl">
            <Box className={classes.container}>
                <Box className={classes.main} style={{flex: matchesSM && 1}}>
                    <TopSummery currentPannelCard={currentData} onCardClick={handleCardClick}/>
                    <DataComponent/>
                </Box>
                {!matchesSM && <Box className={classes.sidebar}>
                   <Sidebar/>
                </Box>}
                {matchesSM && 
                <AppDrawer 
